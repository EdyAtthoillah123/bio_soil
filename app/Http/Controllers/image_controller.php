...
class image_controller extends Controller
{
    ...
    public function store(Request $request){
        ...
        public function imagesave(Request $request){
            ...
            // if($request->$_FILES["webcam"]){
            //     $filenamewithextension = $request->file('webcam')->getClientOriginalName();
            //     $filename= pathinfo($filenamewithextension, PATHINFO_FILENAME);
            //     $extension= $request->file('webcam')->getClientOriginalExtension();
            //     $filenametostore = $filename.'_'.time().'.'.$extension;
            //     $request->file('webcam')->storeAs('public/img', $filenametostore);
            // }
